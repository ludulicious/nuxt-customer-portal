...
1. Confirm npm's `latest` tag points to the intended release for every public package used by the installation guides, including the kit and the configurable portal package.
