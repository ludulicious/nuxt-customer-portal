...
1. Confirm the intended package version in `content/1.getting-started/2.installation.md` matches every public package it installs. The current guide uses the published `0.4.5` release, including the kit and the configurable portal package.
