...
export const documentationCatalog: DocumentationCatalogEntry[] = [
  ...
  { path: '/getting-started/installation', title: 'Installation', description: 'Install the Nuxt Customer Portal packages, configure PostgreSQL, and run the provider migrations.' },
  ...
  { path: '/getting-started/customization', title: 'Customize and brand the portal', description: 'Build a host-owned shell while reusing neutral portal primitives and feature contributions.' },
  ...
  { path: '/architecture/layers', title: 'Nuxt layers', description: 'Compose official npm layers and local providers through the package-ready portal configuration.' },
  ...
  { path: '/modules/platform-layers', title: 'Platform layers', description: 'Understand the reusable foundation packages, their ownership boundaries, and host-owned presentation.' },
  ...
  { path: '/reference/compatibility-and-releases', title: 'Compatibility and releases', description: 'Alpha package compatibility, linked versioning, migrations, and MIT licensing.' },
  ...
  { path: '/reference/source-map', title: 'Product source map', description: 'Open the Nuxt Customer Portal monorepo files behind packages, demos, migrations, and boundary checks.' },
  ...
  { path: '/contributing/create-a-layer', title: 'Create a feature layer', description: 'Author a local Nuxt layer with public portal contracts, feature contributions, and its own migration provider.' },
  { path: '/contributing/distribute-a-layer', title: 'Distribute a feature layer', description: 'Package a Nuxt layer with explicit exports, peers, manifests, migrations, and clean-consumer verification.' },
