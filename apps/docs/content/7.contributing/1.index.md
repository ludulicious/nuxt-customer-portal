...
githubPath: apps/docs/content/7.contributing/1.index.md
navigation:
...
1. Search existing [issues](https://github.com/ludulicious/nuxt-customer-portal/issues) and pull requests, then choose the matching [structured issue form](https://github.com/ludulicious/nuxt-customer-portal/issues/new/choose).
...
Have an idea for a reusable capability? Read [module proposal guidance](/contributing/propose-a-module), then open the [reusable layer proposal form](https://github.com/ludulicious/nuxt-customer-portal/issues/new?template=module-proposal.yml). When the boundary is agreed, continue with [create a feature layer](/contributing/create-a-layer), [distribute the layer](/contributing/distribute-a-layer), and [testing contributions](/contributing/testing). Documentation-only changes have a separate [writing guide](/contributing/documentation). Use [Community and support](/contributing/community) to choose the right channel and report security concerns privately.
