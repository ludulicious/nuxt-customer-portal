...
githubPath: apps/docs/content/7.contributing/6.propose-a-module.md
navigation:
...
Search the [Customer Portal issues](https://github.com/ludulicious/nuxt-customer-portal/issues) and existing modules. If the capability is specific to one deployment, it may still be valuable as an external layer without becoming part of the default portal.

Open the [reusable layer proposal form](https://github.com/ludulicious/nuxt-customer-portal/issues/new?template=module-proposal.yml). GitHub begins the title with `Module proposal:` and asks for the boundary evidence below.
