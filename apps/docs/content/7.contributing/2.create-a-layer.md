...
You can build an extension for your own portal without contributing it to this repository. Keep it local while its requirements evolve; [distribute it as a package](/contributing/distribute-a-layer) if it becomes useful across projects.

This guide uses a Notes module to explain the extension contracts. Start with a [working portal](/getting-started/installation). The examples focus on registration, policies, and data ownership; you still implement the pages, forms, and behavior for your module. For a complete, smaller implementation to study alongside this guide, see the optional [Service Requests example](/modules/service-requests).
