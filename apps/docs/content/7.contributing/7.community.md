...
githubPath: apps/docs/content/7.contributing/7.community.md
navigation:
  icon: i-lucide-messages-square
---

Customer Portal collaboration happens through GitHub Discussions, issues, and pull requests. Choosing the right channel and including useful evidence makes it easier for maintainers and other contributors to respond.

## Where to start

| Need                               | Channel                                                                                                                                                                                  |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Product bug                        | [Bug report form](https://github.com/ludulicious/nuxt-customer-portal/issues/new?template=bug-report.yml)                                                                                |
| Product feature request            | [Feature request form](https://github.com/ludulicious/nuxt-customer-portal/issues/new?template=feature-request.yml)                                                                      |
| Reusable layer idea                | Read [Propose a module](/contributing/propose-a-module), then use the [layer proposal form](https://github.com/ludulicious/nuxt-customer-portal/issues/new?template=module-proposal.yml) |
...
| General implementation question    | Search the docs and existing discussions first, then start a [GitHub Discussion](https://github.com/ludulicious/nuxt-customer-portal/discussions) with a minimal example                 |
...
Documentation reports and pull requests belong in the [documentation repository](https://github.com/ludulicious/nuxt-customer-portal). Product behavior belongs in the [Customer Portal tracker](https://github.com/ludulicious/nuxt-customer-portal/issues). The page action begins documentation issue titles with `Docs:` and includes the source pin automatically, which keeps a report reproducible when the product moves forward.

Use [GitHub Discussions](https://github.com/ludulicious/nuxt-customer-portal/discussions) for implementation questions and broader community conversations. Use an issue for a reproducible bug or a scoped proposal, and keep one issue focused on one problem or proposal.

The product repository also publishes [contribution guidelines](https://github.com/ludulicious/nuxt-customer-portal/blob/master/CONTRIBUTING.md), a [support channel map](https://github.com/ludulicious/nuxt-customer-portal/blob/master/SUPPORT.md), a [security policy](https://github.com/ludulicious/nuxt-customer-portal/blob/master/SECURITY.md), and a pull-request checklist. GitHub surfaces these files automatically while someone creates an issue or pull request.
...
Customer Portal is in active development and publishes versioned releases, but it does not yet publish a support lifecycle. Read [Compatibility and releases](/reference/compatibility-and-releases) before depending on an internal API or deploying an upstream update.
