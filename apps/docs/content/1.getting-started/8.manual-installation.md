...
The examples use the published package version `0.3.1`. Keep every official package on this same version and review the [compatibility guidance](/reference/compatibility-and-releases) before upgrading.
