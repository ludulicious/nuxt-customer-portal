...
The command below installs the published `0.4.3` release. The kit generates a project with matching versions of the portal packages, including `@nuxt-customer-portal/saas-configuration`. See [compatibility and releases](/reference/compatibility-and-releases).
