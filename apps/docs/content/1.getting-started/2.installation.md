...
```bash [pnpm]
pnpm dlx @nuxt-customer-portal/kit@0.3.0 init my-portal
```

```bash [Yarn]
yarn dlx @nuxt-customer-portal/kit@0.3.0 init my-portal
```

```bash [Bun]
bunx @nuxt-customer-portal/kit@0.3.0 init my-portal
```
