...
Enable the client's Invoices module and invoice access for its supplier relationship. Client owners and administrators can then access received invoices and assign additional viewers at `/invoices/viewers`. See [client access](/guides/client-access) for the full setup and permission checks.
