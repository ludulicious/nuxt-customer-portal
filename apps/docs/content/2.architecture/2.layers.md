...
`@nuxt-customer-portal/preset` includes `core`, `ui`, `authentication`, `organizations`, and `clients`. Add `@nuxt-customer-portal/service-requests` and `@nuxt-customer-portal/timesheets` independently.
