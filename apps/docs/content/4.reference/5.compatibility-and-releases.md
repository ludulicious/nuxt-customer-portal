...
All 16 official packages are published on npm at `0.4.4`. The [installation guide](/getting-started/installation) uses this version of the [portal kit](https://www.npmjs.com/package/@nuxt-customer-portal/kit/v/0.4.4) to create a standalone application.
