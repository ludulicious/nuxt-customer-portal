...
All 13 official packages are published on npm at `0.3.3`. The [installation guide](/getting-started/installation) uses this version of the [portal kit](https://www.npmjs.com/package/@nuxt-customer-portal/kit/v/0.3.3) to create a standalone application.
