...
All 13 official packages are published on npm at `0.3.0`. The [installation guide](/getting-started/installation) uses this version of the [portal kit](https://www.npmjs.com/package/@nuxt-customer-portal/kit/v/0.3.0) to create a standalone application.

Timesheets and invoicing are used by the maintainers' software agency. Version `0.3.0` is the first npm release. Evaluate compatibility with your host, deployment, and custom modules before upgrading. Service Requests is an optional example extension for developers.
