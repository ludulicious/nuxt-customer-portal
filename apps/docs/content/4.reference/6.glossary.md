...
A separately versioned Nuxt layer published to a package registry and loaded through `extends`. Official packages share a linked version and expose explicit package entry points.
