...
export const auth = betterAuth({
  ...
  emailAndPassword: {
    ...
    sendResetPassword: async ({ user, url, token }, request) => {
      await sendEmail({
        to: user.email,
        subject: 'Reset your Northstar Studio password',
        params: {
          greeting: 'Hello,',
          body_text:
            'You requested a password reset for your Northstar Studio account. Please click the button below to set a new password:',
          action_url: url,
  ...
  emailVerification: {
    ...
    sendVerificationEmail: async ({ user, url, token }, request) => {
      await sendEmail({
        to: user.email,
        subject: 'Verify your Northstar Studio email address',
        params: {
          greeting: 'Hello,',
          body_text:
            'Thanks for signing up for Northstar Studio! Please click the button below to verify your email address:',
          action_url: url,
          action_text: 'Verify Email',
          footer_text: "If you didn't sign up for Northstar Studio, please ignore this email."
        }
      })
    },
    autoSignInAfterVerification: true,
...
export const statement = {
  ...defaultStatements,
  questionnaire: ['create', 'read', 'update', 'delete', 'list', 'share', 'view-responses'],
...
export const { signIn, signOut, signUp, useSession, getSession, sendVerificationEmail } = authClient
```
