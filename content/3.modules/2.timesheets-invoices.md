...
Portal core places these widgets alongside contributions from other installed features.
...
Feature-owned tables and enums live in the `timesheets` PostgreSQL schema. Cross-schema references connect them to portal-core users and organizations. The root application retains the ordered migration history.
