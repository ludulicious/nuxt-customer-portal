...
Cross-schema foreign keys to portal-core organizations and users are expected. Feature schemas should use deletion behavior deliberately so that organization cleanup cannot leave invalid records.
