...
githubPath: content/1.getting-started/5.ai-access.md
navigation:
  icon: i-lucide-bot
---
...
```text
Rendered: https://portalnuxt.com/architecture/layers
Markdown: https://portalnuxt.com/raw/architecture/layers.md
```
...
- [`/llms.txt`](https://portalnuxt.com/llms.txt) provides the documentation map and descriptions.
- [`/llms-full.txt`](https://portalnuxt.com/llms-full.txt) provides the maintained documentation as one combined context.
...
Product behavior changes quickly. Documentation pull requests should verify public routes, environment variables, policies, and workflows against the current [Customer Portal source](https://github.com/ludulicious/customer-portal). The revision shown on each rendered page and returned by MCP is the public source baseline for the current site. The site’s automated checks keep the MCP catalog aligned with maintained page titles, descriptions, and routes.
