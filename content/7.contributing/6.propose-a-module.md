...
Discussion should establish whether the capability is reusable, whether it needs a new layer or an existing one, and whether any proposed portal-core change is genuinely cross-cutting. Maintainers will also look for a clear authorization vocabulary, tenant boundaries, migration safety, and a first milestone small enough to review.
