...
Open a [new Customer Portal issue](https://github.com/ludulicious/customer-portal/issues/new) with a title beginning `Module proposal:` and use the outline below.
