...
import { invitation as invitationTable, organization as organizationTable, member as memberTable } from '#portal/server/db/schema/auth-schema'
...
defineRouteMeta({
  openAPI: {
    tags: ['General'],
    operationId: 'generalAdminOrganizationsByIdInvitationsByInvitationIdResendPost',
