...
import { organization as organizationTable, member as memberTable } from '#portal/server/db/schema/auth-schema'
import type { SessionUser, Organization } from '#types'
