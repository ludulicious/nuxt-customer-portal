  ...
  emails: [
    {
      ...
      defaults: {
        en: {
          ...
          footer: 'For your security, this code will expire soon and can only be used once. If you did not create or verify an account, you can safely ignore this email.'
        },
        nl: {
          ...
          footer: 'Voor uw veiligheid verloopt deze code binnenkort en kan deze maar één keer worden gebruikt. Heeft u geen account aangemaakt of geverifieerd? Dan kunt u deze e-mail veilig negeren.'
        }
      },
      placeholders: [recipientNamePlaceholder, { key: 'otp', labelKey: 'admin.email.placeholders.otp', example: '123456' }]
    },
    {
      id: 'sign-in',
      ...
      defaults: {
        en: {
          ...
          footer: 'This code will expire soon and can only be used once. If you did not try to sign in, you can ignore this email; no changes will be made to your account.'
        },
        nl: {
          ...
          footer: 'Deze code verloopt binnenkort en kan maar één keer worden gebruikt. Heeft u niet geprobeerd in te loggen? Dan kunt u deze e-mail negeren; er wordt niets aan uw account gewijzigd.'
        }
      },
      placeholders: [recipientNamePlaceholder, { key: 'otp', labelKey: 'admin.email.placeholders.otp', example: '123456' }]
    },
    {
      ...
      defaults: {
        en: {
          ...
          footer: 'For your security, this code will expire soon and can only be used once. If you did not request a password reset, ignore this email and your current password will remain unchanged.'
        },
        nl: {
          ...
          footer: 'Voor uw veiligheid verloopt deze code binnenkort en kan deze maar één keer worden gebruikt. Heeft u geen wachtwoordherstel aangevraagd? Negeer dan deze e-mail; uw huidige wachtwoord blijft ongewijzigd.'
        }
      },
      placeholders: [recipientNamePlaceholder, { key: 'otp', labelKey: 'admin.email.placeholders.otp', example: '123456' }]
    },
    {
      ...
      defaults: {
        en: {
          ...
          footer: 'This code will expire soon and can only be used once. If you did not request this change, ignore this email and review your account security.'
        },
        nl: {
          ...
          footer: 'Deze code verloopt binnenkort en kan maar één keer worden gebruikt. Heeft u deze wijziging niet aangevraagd? Negeer dan deze e-mail en controleer de beveiliging van uw account.'
        }
      },
      placeholders: [recipientNamePlaceholder, { key: 'otp', labelKey: 'admin.email.placeholders.otp', example: '123456' }]
    },
    {
      ...
      defaults: {
        en: {
          ...
          footer: 'This personal invitation will expire soon. If you were not expecting it, you can safely ignore this email.'
        },
        nl: {
          ...
          footer: 'Deze persoonlijke uitnodiging verloopt binnenkort. Verwachtte u deze uitnodiging niet? Dan kunt u deze e-mail veilig negeren.'
        }
      },
      placeholders: [
    ...
    },
    {
      ...
      defaults: {
        en: {
          ...
          footer: 'If you did not request account deletion, do not use the link. You can safely ignore this email and your account will remain active.'
        },
        nl: {
          ...
          footer: 'Heeft u niet gevraagd om uw account te verwijderen? Gebruik de link dan niet. U kunt deze e-mail veilig negeren; uw account blijft actief.'
        }
      },
      placeholders: [
        recipientNamePlaceholder,
