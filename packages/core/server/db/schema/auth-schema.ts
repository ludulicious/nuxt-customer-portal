...
import { pgTable, text, timestamp, boolean, check, index, uniqueIndex, jsonb, integer } from 'drizzle-orm/pg-core'
...
export const user = pgTable(
  ...
  (table) => [index('user_name_idx').on(table.name), uniqueIndex('user_email_idx').on(table.email)]
)
...
export const organization = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('organization_single_provider_uidx')
