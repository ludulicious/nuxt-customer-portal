...
export const timesheetEmails: PortalEmailDefinition[] = [
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'Thank you for taking the time to review this submission. Your prompt response helps keep the approval process moving smoothly.'
      },
      nl: {
        ...
        footer:
          'Bedankt dat u de tijd neemt om deze urenstaat te beoordelen. Met een snelle reactie blijft het goedkeuringsproces soepel verlopen.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'No further action is needed from you right now. You can use the link above whenever you want to review the latest status.'
      },
      nl: {
        ...
        footer:
          'U hoeft op dit moment niets te doen. Via de bovenstaande link kunt u altijd de meest recente status bekijken.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'If the feedback is unclear, please contact the person responsible for the internal review before resubmitting.'
      },
      nl: {
        ...
        footer:
          'Is de feedback niet duidelijk? Neem dan contact op met de interne beoordelaar voordat u de urenstaat opnieuw indient.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      ...
      nl: {
        ...
        footer:
          'Dien de urenstaat opnieuw in zodra uw wijzigingen klaar zijn, zodat het goedkeuringsproces verder kan gaan.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'You can approve the timesheet or raise a concern from the review page. Thank you for helping us complete the process.'
      },
      nl: {
        ...
        footer:
          'Op de beoordelingspagina kunt u de urenstaat goedkeuren of een bezwaar aangeven. Bedankt dat u helpt het proces af te ronden.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'Thank you for keeping the timesheet accurate and complete. No further action is required for this submission.'
      },
      nl: {
        ...
        footer:
          'Bedankt voor het zorgvuldig en volledig bijhouden van de uren. Voor deze inzending hoeft u niets meer te doen.'
      }
    },
    placeholders: [
      {
  ...
  },
  {
    ...
    defaults: {
      en: {
        ...
        footer:
          'Please follow up with the client if clarification is needed. Resolving the concern promptly will help keep the approval process on track.'
      },
      nl: {
        ...
        footer:
          'Neem contact op met de klant als nadere uitleg nodig is. Door het bezwaar snel op te lossen, blijft het goedkeuringsproces op schema.'
      }
    },
    placeholders: [
      {
