...
export const timesheetsFeature: PortalFeatureDefinition<TimesheetAction> = {
  ...
  modules: [
    {
      ...
      menuItems: [
        ...
        },
        {
          ...
          labelKey: 'features.timesheets.approvals.reviewersTitle',
          icon: 'i-lucide-users-round',
          to: '/timesheets/approvals/reviewers',
          audiences: ['clientAdmin']
        },
        {
          id: 'supplier-timesheets',
          labelKey: 'features.timesheets.suppliers.title',
          icon: 'i-lucide-building-2',
          to: '/timesheets/suppliers',
          audiences: ['authenticated']
        ...
        },
        {
          ...
          labelKey: 'features.timesheets.admin.projects',
          icon: 'i-lucide-folder-kanban',
          to: '/admin/timesheets/projects',
          audiences: ['providerAdmin']
        },
        {
          id: 'timesheet-activities',
          labelKey: 'features.timesheets.admin.activities',
          icon: 'i-lucide-tags',
        ...
        {
          id: 'timesheet-rates',
          labelKey: 'features.timesheets.admin.teamRates',
        ...
        },
        {
          ...
          labelKey: 'features.timesheets.admin.workspaceSettings',
        ...
        },
        {
          ...
          labelKey: 'features.timesheets.admin.reports',
          icon: 'i-lucide-chart-no-axes-combined',
  ...
  dashboardWidgets: [
    { id: 'timesheets-my-week', component: 'TimesheetsDashboardMyWeek', area: 'main', size: 'half', order: 20 },
    {
      ...
      component: 'TimesheetsDashboardInternalApprovals',
      area: 'attention',
      size: 'half',
      order: 10
    },
    {
      id: 'timesheets-client-approvals',
      component: 'TimesheetsDashboardClientApprovals',
      area: 'attention',
      size: 'half',
      order: 20
    },
    {
      id: 'timesheets-supplier-timesheets',
      component: 'TimesheetsDashboardSupplierTimesheets',
      area: 'main',
      size: 'half',
      order: 25
    }
  ...
  clientIntegration: {
    moduleId: 'timesheets',
    labelKey: 'features.timesheets.navigation.myTimesheet',
    detailComponent: 'TimesheetsClientSettingsPanel'
  },
  policy: {
