...
import { listClientReviewers } from '@nuxt-customer-portal/timesheets/server/utils/timesheet-repository'
...
export default defineEventHandler(async (event) => {
  ...
  return listClientReviewers(getRouterParam(event, 'workspaceClientId')!, organizationId)
})
