...
import { getBootstrap, requireTimesheetWorkspace } from '@nuxt-customer-portal/timesheets/server/utils/timesheet-repository'
...
operationId: 'timesheetsBootstrapGet',
    ...
    description: 'Get timesheets workspace data. Scoped to the active organization and the applicable Timesheets permission.'
  }
})
