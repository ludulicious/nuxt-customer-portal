  ...
  <div class="border-y border-default py-2">
    <div class="flex items-center gap-2">
      ...
      <template v-if="!isMobile">
        ...
        <UButton variant="outline" :icon="sortDir === 'asc' ? 'i-lucide-arrow-up' : 'i-lucide-arrow-down'" :aria-label="t('features.timesheets.admin.list.direction')" @click="emit('toggleDirection')" />
      </template>
      <template v-else>
