...
export const clientsFeature: PortalFeatureDefinition<ClientAction> = {
  id: 'clients',
  navigation: [{ id: 'clients', labelKey: 'features.clients.title', icon: 'i-lucide-building-2', to: '/clients', audiences: ['providerAdmin'], order: 20 }],
  modules: [{
    id: 'clients', labelKey: 'features.clients.title', icon: 'i-lucide-building-2', to: '/clients', routePrefixes: ['/clients'], audiences: ['providerAdmin'], order: 20,
    menuItems: [{ id: 'clients-list', labelKey: 'features.clients.title', icon: 'i-lucide-building-2', to: '/clients', audiences: ['providerAdmin'] }]
  }],
  policy: {
