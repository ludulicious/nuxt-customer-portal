...
const { contributionsFor } = usePortalFeatures()
const organizationPanels = contributionsFor('administration.organization.detail')
const resolvePanel = (component: string) => resolveComponent(component)
    ...
    <UContainer>
      ...
      <div v-else-if="organization && hasPermission('organization', 'read')" class="space-y-6">
        ...
        <component
          ...
          v-for="panel in organizationPanels"
          :key="panel.id"
