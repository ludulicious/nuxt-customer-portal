...
import { invitation as invitationTable, organization as organizationTable, member as memberTable } from '@nuxt-customer-portal/core/server/db/schema/auth-schema'
