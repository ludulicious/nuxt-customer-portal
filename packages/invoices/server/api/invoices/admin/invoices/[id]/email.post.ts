...
defineRouteMeta({
  openAPI: {
    tags: ['Invoices'],
operationId: 'invoicesAdminInvoicesByIdEmailPost',
    summary: 'Send an invoice email',
    description: 'Send an invoice email. Scoped to the active organization and the applicable Invoices permission.'
  }
})
