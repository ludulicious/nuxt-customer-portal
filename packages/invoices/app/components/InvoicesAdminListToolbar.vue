...
<template>
  <div class="border-y border-default py-2">
    <div class="flex items-center gap-2">
      <UInput v-model="search" :placeholder="t('features.invoices.admin.list.search')" icon="i-lucide-search" class="min-w-0 flex-1 md:max-w-xs" />
      ...
      <template v-else>
        ...
        <UButton variant="outline" icon="i-lucide-arrow-down-up" :aria-label="t('features.invoices.admin.list.sort')" @click="showSort = true" />
      </template>
    </div>
