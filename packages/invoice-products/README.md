...
The integration uses the public Invoices commerce contract and registers through Products' purchase integration. Polar is not implemented: merchant-of-record transactions must not issue a second seller invoice through this Stripe integration.
